        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
             Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi, sapiente, omnis ab veniam optio maxime in magnam cum consequuntur nostrum quis enim numquam similique velit consectetur ut pariatur autem? Dolores.
            </p>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Trusted by <span className="text-indigo-600">10000+</span>{" "}
            customers worldwide
          </div>
